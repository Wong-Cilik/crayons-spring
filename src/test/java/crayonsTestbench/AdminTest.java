...
public class AdminTest extends TestBenchTestCase {
	...
	public void testChangeUserRigthsToStudent() {
		...
		$(ButtonElement.class).caption(lang.getString("AdminView")).first()
				.click();

		// Find an entry for the user "student@mail.com" in the table
		int i = 0;
		while (!($(TableElement.class).first().getCell(i, 0).getText()
				.equals("student@mail.com")))
			i++;
		...
		assertEquals(lang.getString("RightsUpdatedSuccessfully"),
				notification.getCaption());

		// 7. Assert that the user permissions information in the table is right
		assertEquals($(TableElement.class).first().getCell(i, 2).getText(),
		...
		// 10. Assert that the student can see Userlibrary, Preferences, and
		// Search only
		assertFalse($(ButtonElement.class).caption(
				lang.getString("Authorlibrary")).exists());
		assertTrue($(ButtonElement.class)
				.caption(lang.getString("Userlibrary")).exists());
		assertTrue($(ButtonElement.class)
				.caption(lang.getString("Preferences")).exists());
		assertTrue($(ButtonElement.class).caption(lang.getString("Search"))
				.exists());
		assertFalse($(ButtonElement.class).caption(lang.getString("AdminView"))
				.exists());
	...
	public void testChangeUserRigthsToAuthor() {
		...
		// 10. Assert that the student can see Authorlibrary, Userlibrary,
		// Preferences, and Search
		assertTrue($(ButtonElement.class).caption(
				lang.getString("Authorlibrary")).exists());
		assertTrue($(ButtonElement.class)
				.caption(lang.getString("Userlibrary")).exists());
		assertTrue($(ButtonElement.class)
	...
	public void testChangeUserRigthsToAdmin() {
		...
		// 10. Assert that the admin can see Authorlibrary, Userlibrary,
		// Preferences, Search, and User permissions
		assertTrue($(ButtonElement.class).caption(
				lang.getString("Authorlibrary")).exists());
		assertTrue($(ButtonElement.class)
				.caption(lang.getString("Userlibrary")).exists());
		...
		assertTrue($(ButtonElement.class).caption(lang.getString("Search"))
				.exists());
		assertTrue($(ButtonElement.class).caption(lang.getString("AdminView"))
				.exists());
	...
	public void testDeleteUser() {
		...
		// 6. Click "Delete user"
		$(ButtonElement.class).caption(lang.getString("DeleteUser")).first()
				.click();
	...
	private void createNewUser() {
		$(ButtonElement.class).caption(lang.getString("Register")).first()
				.click();
		...
		$(NativeSelectElement.class)
				.caption(lang.getString("SelectYourLanguage")).first()
				.setValue(lang.getString("German"));
		$(ButtonElement.class).caption(lang.getString("CreateUser")).first()
				.click();
	}
}
