...
public class RegistrationTest extends TestBenchTestCase {
	...
	public void testEmailExist() {
		...
		$(NativeSelectElement.class)
				.caption(lang.getString("SelectYourLanguage")).first()
				.setValue(lang.getString("English"));

		// 7. Click "Register" to finish the registration
		$(ButtonElement.class).caption(lang.getString("CreateUser")).first()
				.click();

		// 8. Assert that the user gets a notification that the email address
		// already in use
		NotificationElement notification = $(NotificationElement.class).first();
		assertEquals(lang.getString("EmailAlreadyExists"),
	...
	public void testWrongEmail() {
		...
		// 8. Assert that the user gets a notification that the email is not
		// valid
		NotificationElement notification = $(NotificationElement.class).first();
		assertEquals(lang.getString("EmailIsNotValid"),
				notification.getCaption());
	}
	...
	public void testShortPassword() {
		...
		// 8. Assert that the user gets a notification that the password is too
		// short
		NotificationElement notification = $(NotificationElement.class).first();
	...
	public void testLongPasswort() {
		...
		// 5. Enter "123456" into the Password field
		$(PasswordFieldElement.class).first().setValue(
	...
	public void testFirstNameInvalid() {
		...
		// long
		NotificationElement notification = $(NotificationElement.class).first();
		assertEquals(lang.getString("FirstnameOrLastnameAreNotValid"),
				notification.getCaption());
	}
	...
	public void testEmailIsTooLong() {
		...
		// 4. Enter "client@web.de" into the Email field
		$(TextFieldElement.class).get(2).setValue(
				"clientclientclientclientclient@web.de");
