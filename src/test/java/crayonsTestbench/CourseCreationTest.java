...
public class CourseCreationTest extends TestBenchTestCase {
    ...
    public void testCreateAndDeleteCourse() {
        ...
        // 6. Enter "Algebra is one of the broad parts of mathematics." into the Course Description field 
        ...
        $$(WindowElement.class).caption("").$(TextFieldElement.class).first().clear();
        
        // 11. Enter "Biology" into the Course Title field 
        $$(WindowElement.class).caption("").$(TextFieldElement.class).first().setValue("Biology");
            
        // 12. Clear the Course Description field 
        $(TextAreaElement.class).first().clear();
        
        // 13. Enter "Biology is the study of life." into the Course Description field 
        $(TextAreaElement.class).first().setValue("Biology is the study of life.");
    ...
    public void testCreateTwoCoursesWithEqualNames() {
        ...
        // 6. Enter "Physics is the natural science." into the Course Description field 
        ...
        // 10. Enter "Physics is the natural science." into the Course Description field 
        $(TextAreaElement.class).first().setValue("Physics is the natural science.");
        
        // 11. Click "CreateCourse"
        $(ButtonElement.class).caption(lang.getString("CreateCourse")).first().click();
        
        // 12. Assert that the user gets a notification that the course name already in use
