...
public class CouseAvailabilityTest extends TestBenchTestCase {
    ...
    public void testAddAndRemoveParticipant() {
        ...
        // 3. Select "student@mail.com" from the List of all students and move them to the Participants
        ...
        // 8. Assert that the TabSheet contains "Algera". It means that the course became available
        // for the student
        ...
        // 12. Select "student@mail.com" from the Participants and move them to the List of all students 
        $(TwinColSelectElement.class).caption(lang.getString("SelectParticipants"))
        ...
        // 16. Assert that the TabSheet doesn't contain "Algebra" anymore. It means that the course 
    ...
    public void testParticipantLeavesTheCourse() {
        ...
        $(ButtonElement.class).caption(lang.getString("LeaveTheCourse")).first().click();
        ...
        // 15. Assert that the participants list doesn't contain "student@mail.com" anymore 
        assertFalse($(TwinColSelectElement.class).caption(lang.getString("SelectParticipants"))
                .first().getValues().contains("student@mail.com"));
