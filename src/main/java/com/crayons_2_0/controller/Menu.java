...
public class Menu extends CssLayout {
	...
	/*
	 * User anzeigen private User getCurrentUser() { return (User)
	 * VaadinSession.getCurrent().getAttribute( User.class.getName()); } public
	 * void updateUserName(final ProfileUpdatedEvent event) { User user =
	 * getCurrentUser(); settingsItem.setText(user.getFirstName() + " " +
	 * user.getLastName()); }
	 */
	public Menu(Navigator navigator) {
		...
		final Button showMenu = new Button(lang.getString("Menu"),
				new ClickListener() {
					/**
             * 
             */
	...
	/*
	 * private Component buildUserMenu() { final MenuBar settings = new
	 * MenuBar(); settings.addStyleName(VALO_MENU_TOGGLE); //final User user =
	 * getCurrentUser(); profileItem = settings.addItem("", new ThemeResource(
	 * "img/profile-pic-300px.jpg"), null); //updateUserName(null);
	 * profileItem.addSeparator(); return settings;
	 * 
	 * }
	 */
